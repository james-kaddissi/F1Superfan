...
public func fullName(for favoriteDriver: String) -> String {
    switch favoriteDriver.lowercased() {
    case "hamilton":
...
public func firstName(for favoriteDriver: String) -> String {
    switch favoriteDriver.lowercased() {
    case "hamilton":
        return "Lewis"
    case "russell":
...
public func lastName(for favoriteDriver: String) -> String {
    switch favoriteDriver.lowercased() {
    case "hamilton":
        return "Hamilton"
    case "russell":
